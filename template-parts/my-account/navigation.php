<div class="nova-account-navaigation  w-full border border-solid border-[#D2D2D2] p-4 rounded self-start">
    ...
    <?php
	$has_payment_types = get_field( 'payment_type', 'user_' . get_current_user_id() );
	?>
    <div class="">
        ...
        <?php if ( $has_payment_types ) : ?>
        <a href="<?php echo esc_url( wc_get_endpoint_url( 'orders' ) . '?order_status=pending' ); ?>"
            class="block text-[12px] text-black uppercase mb-2 pl-4">PENDING PAYMENTS</a>
        <?php endif; ?>
