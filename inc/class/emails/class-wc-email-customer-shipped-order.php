...
if ( ! class_exists( 'WC_Email_Customer_Shipped_Order', false ) ) :
	...
	class WC_Email_Customer_Shipped_Order extends WC_Email {
		...
		public function __construct() {
			...
			$this->description    = __( 'Order shipped emails are sent to customers when their orders have been shipped.', 'woocommerce' );
		...
		public function get_default_subject() {
			return __( 'Your {site_title} order is now shipped', 'woocommerce' );
		}
		...
		public function get_default_heading() {
			return __( 'Thanks for your patience.', 'woocommerce' );
		}
