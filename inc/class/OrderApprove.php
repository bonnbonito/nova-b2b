...
class OrderApprove {
	...
	public function update_email_mockup() {
		...
		if ( $role_instance ) {
			...
			$message .= '<ol>';
			$message .= '<li>Please review the updated mockup: <a target="_blank" href"' . home_url() . '/review-mockup?order_id=' . $order_id . '">' . home_url() . '/review-mockup?order_id=' . $order_id . '</a></li>';
