...
{order_details}
	...
	public function admin_notification_paid_full( $order_id ) {
		...
		if ( get_post_meta( $order_id, '_adjusted_duplicate_order_id', true ) ) {
			return;
		}
	...
	public function display_overdue_pending_payment_orders( $customer_id ) {
		...
		if ( empty( $orders ) ) {
			echo '<div class="text-center inline-flex flex-wrap flex-col justify-center content-center w-full"><div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md" role="alert">
			<div class="flex">
