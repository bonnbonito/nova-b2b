export const allAttributes = item => [
  ...
  { key: item.etchedMetalFinish, label: 'METAL FINISHING' },
  { key: item.etchedAnodizedColor, label: 'ANODIZED COLOR' },
  { key: item.etchedAnodizedFinishing, label: 'ANODIZED FINISHING' },
  { key: item.etchedGraphicsStyle, label: 'ETCHING STYLE' },
  ...
  { key: item.metalFilm, label: 'METAL FILM' },
  { key: item.pvcBaseColor?.name, label: 'PVC BASE COLOR' },
  { key: item.pvcBase, label: 'PVC BASE' },
  ...
  { key: item.returnCustomColor, label: 'RETURN CUSTOM COLOR' },
