...
import { Logo as AcryMetalLogo } from '../acrylic/AcryMetal/components/Logo';
import { Letters as AcryMetalLetters } from '../acrylic/AcryMetal/components/Letters';
/*Metal */
...
import { Logo as PVCMetalLogo } from '../pvc/PVCMetal/components/Logo';
import { Letters as PVCMetalLetters } from '../pvc/PVCMetal/components/Letters';
/*LED */
...
/** WAYFINDING */
import { EtchedSign as EtchedFabricated } from '../wayfinding/EtchedFabricated/components/EtchedSign';
import { EtchedSign as EtchedFlatCut } from '../wayfinding/EtchedFlatCut/components/EtchedSign';
...
export default function CombineQuotes() {
  const { signage, setSignage, setTempFolder, tempFolderName, setPartner } = useAppContext();
    ...
    switch (item.component) {
      case 'pvcMetal':
        if (item.type === 'letters') {
          output = <PVCMetalLetters key={item.id} item={item} productId={item.product} />;
        } else {
          output = <PVCMetalLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'EtchedFabricated':
        output = <EtchedFabricated key={item.id} item={item} productId={item.product} />;
        break;
      case 'EtchedFlatCut':
        output = <EtchedFlatCut key={item.id} item={item} productId={item.product} />;
        break;
      case 'AcryMetal':
        if (item.type === 'letters') {
          output = <AcryMetalLetters key={item.id} item={item} productId={item.product} />;
        } else {
          output = <AcryMetalLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'ThreeDLayer':
        output = <ThreeDLayer key={item.id} item={item} productId={item.product} />;
        break;
      case 'AcrylicSideLit':
        if (item.type === 'letters') {
          output = <AcrylicSideLitLetters key={item.id} item={item} productId={item.product} />;
        } else {
          output = <AcrylicSideLitLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'AcrylicFrontSideLit':
        if (item.type === 'letters') {
          output = (
            <AcrylicFrontSideLitLetters key={item.id} item={item} productId={item.product} />
          );
        } else {
          output = <AcrylicFrontSideLitLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'AcrylicFrontBackLit':
        if (item.type === 'letters') {
          output = (
            <AcrylicFrontBackLitLetters key={item.id} item={item} productId={item.product} />
          );
        } else {
          output = <AcrylicFrontBackLitLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'AcrylicBackLit':
        if (item.type === 'letters') {
          output = <AcrylicBackLitLetters key={item.id} item={item} productId={item.product} />;
        } else {
          output = <AcrylicBackLitLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'AcrylicFrontLit':
        if (item.type === 'letters') {
          output = <AcrylicFrontLitLetters key={item.id} item={item} productId={item.product} />;
        } else {
          output = <AcrylicFrontLitLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'CustomProject':
        output = <CustomProject key={item.id} item={item} productId={item.product} />;
        break;
      case 'RigidNeonSignNoBacking':
        output = <RigidNeonSignNoBacking key={item.id} item={item} productId={item.product} />;
        break;
      case 'RigidNeonSignWithBacking':
        output = <RigidNeonSignWithBacking key={item.id} item={item} productId={item.product} />;
        break;
      case 'FlexNeonSign':
        output = <FlexNeonSign key={item.id} item={item} productId={item.product} />;
        break;
      case 'AluminumResinFrontBackLit':
        if (item.type === 'letters') {
          output = <AluminumResinFrontBackLit key={item.id} item={item} productId={item.product} />;
        } else {
          output = (
            <AluminumResinFrontBackLitLogo key={item.id} item={item} productId={item.product} />
          );
        }
        break;
      case 'AluminumResinFrontLit':
        if (item.type === 'letters') {
          output = <AluminumResinFrontLit key={item.id} item={item} productId={item.product} />;
        } else {
          output = <AluminumResinFrontLitLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'PVCUv':
      ...
      case 'PVCMetalLaminate':
        if (item.type === 'letters') {
          output = <PVCMetalLaminateLetters key={item.id} item={item} productId={item.product} />;
        } else {
          output = <PVCMetalLaminateLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'PVCPainted':
        if (item.type === 'letters') {
          output = <PVCPaintedLetters key={item.id} item={item} productId={item.product} />;
        } else {
          output = <PVCPaintedLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'TrimLessFrontAndBackLit':
        if (item.type === 'letters') {
          output = <TrimLessFrontAndBackLit key={item.id} item={item} productId={item.product} />;
        } else {
          output = (
            <TrimLessFrontAndBackLitLogo key={item.id} item={item} productId={item.product} />
          );
        }
        break;
      case 'TrimLessFrontLit':
        if (item.type === 'letters') {
          output = <TrimLessFrontLit key={item.id} item={item} productId={item.product} />;
        } else {
          output = <TrimLessFrontLitLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'TrimLessBackLit':
        if (item.type === 'letters') {
          output = <TrimLessBackLit key={item.id} item={item} productId={item.product} />;
        } else {
          output = <TrimLessBackLitLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'MetalFabricated':
        if (item.type === 'letters') {
          output = <MetalFabricatedLetters key={item.id} item={item} productId={item.product} />;
        } else {
          output = <MetalFabricatedLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'MetalAluminum':
        if (item.type === 'letters') {
          output = <MetalAluminumLetters key={item.id} item={item} productId={item.product} />;
        } else {
          output = <MetalAluminumLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'MetalStainless':
        if (item.type === 'letters') {
          output = <MetalStainlessLetters key={item.id} item={item} productId={item.product} />;
        } else {
          output = <MetalStainlessLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'AcryLic':
        if (item.type === 'letters') {
          output = <AcrylicLetters key={item.id} item={item} productId={item.product} />;
        } else {
          output = <AcrylicLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      case 'Acrylic3D':
        output = <Acrylic3D key={item.id} item={item} productId={item.product} />;
        break;
      case 'AcrylicUV':
        output = <AcrylicUV key={item.id} item={item} productId={item.product} />;
        break;
      case 'AcrylicMetalLaminate':
        if (item.type === 'letters') {
          output = <AcrylicMetalLetters key={item.id} item={item} productId={item.product} />;
        } else {
          output = <AcrylicMetalLogo key={item.id} item={item} productId={item.product} />;
        }
        break;
      default:
            ...
            <div className="gap-2">
              ...
              <div className=" border-gray-200 p-4 rounded-md border">
                {productLines.map(productLine => {
                  const uniqueKey = `product-line-${productLine.product_line.ID}`;
                  return (
                    <AccordionGroup
                      key={uniqueKey}
