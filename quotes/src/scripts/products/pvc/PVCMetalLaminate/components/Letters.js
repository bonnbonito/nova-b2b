...
import { finishingOptions, mountingOptions, thicknessOptions } from '../../pvcOptions';
...
export function Letters({ item }) {
  ...
  const handleChangeMetalLaminate = e => {
    const selectedLaminate = metalFinishColors.find(laminate => laminate.name === e.target.value);
