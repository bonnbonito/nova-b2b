...
import { vinlyl3635Options, whiteOptionsResin } from '../../../../utils/ColorOptions';
...
export function Letters({ item }) {
  ...
  const [acrylicReturn, setAcrylicReturn] = useState(item.acrylicReturn ?? 'White');
  ...
  const computePricing = () => {
    ...
    const oversizeShippingAddon = calculateOversizeShippingAddon([selectedLetterHeight], tempTotal);
