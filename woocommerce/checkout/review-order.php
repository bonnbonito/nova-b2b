    ...
    <tfoot>
        ...
        <tr class="payment-selection">
            ...
            <td colspan="2" class="px-4 py-8">
				...
				?>
                <ul id="payment-select" class="update_totals_on_change">
                    <li>
                        <label for="payment_0" class="block justify-end p-3 border rounded-md w-full max-w-sm">
                            <input id="payment_0" type="radio" name="deposit_chosen" value="0"
                    ...
                    <li>
                        <label for="payment_<?php echo $selection['id']; ?>"
                            ...
                            <input id="payment_<?php echo $selection['id']; ?>" type="radio" name="deposit_chosen"
