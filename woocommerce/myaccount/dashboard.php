...
<div class="grid grid-cols-1 gap-x-6 gap-y-4 md:grid-cols-2">
    <a href="<?php echo esc_url( wc_get_endpoint_url( 'edit-account' ) ); ?>"
        ...
        <p class="tracking-[1.4px] text-black text-[14px] leading-loose">Fusce vel eleifend tortor, placerat gravida
            nunc. Sed scelerisque lacus nec nulla eleifend, id tempor nisl</p>
    </a>
