 ...
 */
define( 'PDF_HEADER_LOGO', 'nova-logo.png' );
 ...
 * Document creator.
 */
define( 'PDF_CREATOR', 'NOVA' );

/**
 * Document author.
 */
define( 'PDF_AUTHOR', 'NOVA' );

/**
 * Header title.
 */
define( 'PDF_HEADER_TITLE', 'NOVA Signage' );

/**
 * Header description string.
 */
define( 'PDF_HEADER_STRING', 'by Nova Signage' );
